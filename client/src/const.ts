...
export const APP_TITLE = import.meta.env.VITE_APP_TITLE || "Sistema de Asistencia Automatizado";

export const APP_LOGO = "https://placehold.co/128x128/E1E7EF/1F2937?text=SAA";

export const APP_DESCRIPTION = "Control de asistencia en tiempo real mediante visión por computadora";
